...
class CustomUserManager(BaseUserManager):
    def create_user(self, username, email, phone_number, password=None, **extra_fields):
        ...
        try:
            ...
            logger.error(f"'{email} this user tried fake number like {phone_number}")
    ...
    def create_superuser(self, username, email, phone_number, password=None, **extra_fields):
        ...
        logger.info(f"The user of this email '{email}' is going to register as a admin")
    ...
    def login_user(self, login_input, password, **extra_fields):
        try:
            ...
            logger.error('Unable to find the email or phone number or username')
            return None
